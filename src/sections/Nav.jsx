  ...
  return (
    <nav
      style={{
        ...
        right: 0,
        zIndex: 100,
        padding: scrolled ? '10px 56px' : '24px 56px',
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: 1280 - 112, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: scrolled ? 24 : 32, fontSize: scrolled ? 13 : 14, color: C.ink, alignItems: 'center', transition: 'gap 220ms ease, font-size 220ms ease' }}>
          ...
          <a href="https://app.renderment.com/register" style={{ background: C.ink, color: C.bg, padding: scrolled ? '7px 14px' : '10px 18px', borderRadius: 6, fontSize: scrolled ? 12 : 13, fontWeight: 600, cursor: 'pointer', textDecoration: 'none', display: 'inline-block', transition: 'padding 220ms ease, font-size 220ms ease' }}>Start trial</a>
        </div>
      </div>
    </nav>
  );
